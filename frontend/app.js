...
const AUTH0_CLIENT_ID = 'wlU8gZK5KgG1jhry15Z86XxP3DPi1Wbe';
const AUTH0_DOMAIN = 'dev--4jltzn2.eu.auth0.com';
const AUTH0_CALLBACK_URL = window.location.href; // eslint-disable-line
const PUBLIC_ENDPOINT = 'https://683zknlcya.execute-api.us-east-1.amazonaws.com/staging/api/public';
const PRIVATE_ENDPOINT = 'https://683zknlcya.execute-api.us-east-1.amazonaws.com/staging/api/private';
